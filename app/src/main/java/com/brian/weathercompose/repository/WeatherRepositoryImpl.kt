...
import com.brian.weathercompose.network.WeatherContainer
...
class WeatherRepositoryImpl(private val weatherApi: WeatherApi): WeatherRepository {
    ...
    override suspend fun getForecast(zipcode: String): ApiResponse<ForecastContainer> = handleApi {
        weatherApi.retrofitService.getForecast(zipcode)
    }

    override suspend fun getSearchResults(location: String): ApiResponse<List<Search>> = handleApi {
        weatherApi.retrofitService.locationSearch(location)
    }

    override suspend fun getWeather(zipcode: String, resources: Resources, sharedPreferences: SharedPreferences): WeatherDomainObject {
    ...
    override suspend fun getWeatherListForZipCodes(zipcodes: List<String>, resources: Resources, sharedPreferences: SharedPreferences): List<WeatherDomainObject> {
